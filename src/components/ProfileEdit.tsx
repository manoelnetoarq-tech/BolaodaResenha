...
import { 
  ...
  Bell, BellRing, BellOff, Smartphone, Apple
} from 'lucide-react';
        ...
        <div className="flex flex-col gap-6">
          ...
          <section className="flex flex-col gap-2 pt-2">
            ...
            <button 
              ...
              className="w-full bg-white border border-[#eceef0] p-3.5 rounded-2xl flex items-center justify-between shadow-sm hover:bg-[#eceef0]/30 transition-colors cursor-pointer group mb-1"
            >
